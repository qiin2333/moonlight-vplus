...
object StreamActionRegistry {
    ...
    val BUILTIN = linkedMapOf(
        ...
        "send_win" to StreamAction("send_win", "WIN", R.drawable.ic_btn_win, tintableIcon = true),
        "send_esc" to StreamAction("send_esc", "ESC", R.drawable.ic_btn_esc, tintableIcon = true),
        "toggle_hdr" to StreamAction("toggle_hdr", "HDR", R.drawable.ic_btn_hdr, tintableIcon = true),
        ...
        "send_tab" to StreamAction("send_tab", "Tab", R.drawable.ic_btn_keyboard, tintableIcon = true),
        "send_alt_tab" to StreamAction("send_alt_tab", "Alt+Tab", R.drawable.ic_btn_keyboard, tintableIcon = true),
        "send_alt_f4" to StreamAction("send_alt_f4", "Alt+F4", R.drawable.ic_btn_esc, tintableIcon = true),
